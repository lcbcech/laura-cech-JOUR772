...
**Answer**
We created a new variable called "selected_journalism_courses" and it's important if we want to filter and sort based on the results of our previous filtering/selecting.
...
**Answer:**
The date columnn has changed to from a character field to a date field.
...
**Answer**
The column has pulled out the year, month, and defaulted to 1 for the date. A potential issue of some months having two digits and some having one seems to be fine.
As to why there's more expenses in June than other months, I'd guess it has to do either with the fiscal year or the primary election season.
