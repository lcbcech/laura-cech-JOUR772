...
**Answer** There's a date and title of a news release
...
**Answer** A link to the actual document
...
**Answer** Guessing 3: social media, menu items and list.
...
**Answer** Social media links, menu navigation items and list of press releases
...
**Answer** It's all one column of "value."
