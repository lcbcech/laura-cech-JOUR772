...
**Answer** 4 columns of data: date, title, url and large block of text
...
**Answer** one column with 647,091 entries with each word used in press releases
...
**Answer** yes, more substantive words now.
...
**Answer** We can see top words and percentages.
...
**Task** Run the following code and describe the results.
**Answer** human rights, equal rights, health care, and tax credit are the top words.	
...
**Answer** The assignment of sentiments of positive and negative seem mostly accurate. Words like "issue," and "cancer" depend on context, and "critical" in this context probably means "important," which is more positive.
