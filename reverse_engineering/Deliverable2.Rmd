...
* **Analysis summary**: [Write up two to three sentences describing the results of your analysis.  Were you able to confirm the finding? If not, why not?] If we add the total enrollment of 2019-20 minus the total enrollment of 2021-22, we get a difference of 1,205,907.
