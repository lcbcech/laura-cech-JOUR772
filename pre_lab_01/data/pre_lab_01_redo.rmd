...
**Answer**
Grouping by term, then counting classes
...
**Answer**
It's arranged by term and department.
...
**Answer**
It counted classes and total seats. It's in descending order by total seats.
...
It shows mean and median seats, which I believe may also show average class size. 
The largest number of seats are available for Fall courses.
...
**Answer**
It shows the most seats by department. 
...
1.  Which classes have the most seats?

2.  Difference between number of classes available in Fall and number available in the Spring

3.  Not sure if it's possible but would like to see the new courses offered (not offered previous years)
