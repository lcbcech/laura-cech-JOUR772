...
A5: There are 18 grants, half of which are providing funds to the University of Maryland. To clean the results, I could capitalize all UMD and University of Maryland grantees. If it doesn't matter where at UMD the grants are going, I could mutate the data so that all variations of UMD and University Maryland became a single UMD datafield. 
