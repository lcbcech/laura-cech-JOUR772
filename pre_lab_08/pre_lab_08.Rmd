...
**Answer**
We created a column of months with the total number of calls for each.
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer**
Along the axis, the months are shown, with bars showing the count.
...
**Answer**
The months are now in order, showing bars with lowest counts to highest counts.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? 
**Answer**
The background of the chart is lighter and cleaner-looking.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? 
**Answer**
The biggest change is that it has color, title, and source credit.
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer**
A line chart shows the ups and downs of call numbers by month. It looks a bit like an EKG.
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer**
Still pretty illegible but text along the x axis is angled.
