...
**A1.** https://datawrapper.dwcdn.net/QTKdw/1/
I first tried to show all the candidates but realized that was too confusing. So, then I made a dataframe showing counties and Cox and Hogan's percentages of total votes. The side-by-side bar was the best way to show the difference.
...
```{r}
combinedwins <- full_join(hoganwins, coxwins, by = "County")
...
```{r}
combinedwins |>
  select(County, CoxPercent, HoganPercent) |>
