...
**Task** Run the following codeblock to calculate the percentage change and put the state with the largest percentage growth below. **Answer** Nevada's population grew 35 percent from	1,998,257 in 2000 to	2,700,551.
...
**Task** Run the following codeblock to find the Maryland county with the highest median household income and put the answer below. **Answer** Howard County has the highest median household income --$129,549-- in Maryland.
...
**Task** Run the following codeblock to create a chart showing the margin of error for each county. The current headline isn't very descriptive of the data. What should it be? **Answer** Margin of error in Household income by county in Maryland
...
Is the difference between Calvert and Montgomery significant? **Answer** Calvert and Montgomery Counties are within the margin of error.
...
**Answer**
What is the household income for schools with the highest number of high school graduates enrolled in college?
...
**Answer**
The average income for households for high schools with 60 or more graduates immediately enrolling in college (50 of them) is $111,448. The average income for high schools with less than 40 percent (76 of them) is $69,252.
...
You could look at individual schools to see the highest number of graduates and those going to college. 
