...
**Answer**
Eight columns, with zip codes and other data, along with shape dimensions
...
**Task** Run the following code. Describe the output in the space below: what kind of information does it contain? **Answer** zip code, town names, shape length, area and geometry
...
**Answer** A Maryland map with boundary lines of zip codes.
...
**Task** Run the following code. Describe the output in the space below. 
**Answer** Data frame with 18 columns that include counties, town names, coordinates, etc.
...
**Task** Run the following code. Describe the output in the space below. 
**Answer** Same data filtered by Maryland counties and Baltimore city
...
**Task** Run the following code. Describe the output in the space below. 
**Answer** Maryland map with county boundaries shown
...
**Task** Run the following code. Describe the output in the space below. 
**Answer** Now we can see the Chesapeake Bay, the boundaries of zip codes and counties
...
**Task** Run the following code. Describe the output in the space below. 
**Answer**
Dataframe with two columns of info: zip codes and numbers of forclosures as of Marchh 2023
...
**Task** Run the following code. Describe the output in the space below. 
**Answer**
Dataframe with 9 columns and 526 rows
...
**Task** Run the following code. Describe the output in the space below. 
**Answer** Now you can see the map with the areas of high numbers of foreclosures in a bright blue color. They are outside of D.C. in southern Prince George's County, in Baltimore and in Cecil County.
...
**Task** Run the following code. Describe the output in the space below. 
**Answer** A dataframe with four columns, including each county and number of notices.
...
**Task** Run the following code. Describe the output in the space below. 
**Answer** Dateframe with 6 columns, 25 rows that includes each county and Baltimore with GEOIDs, estimate, multipolygon, etc. 
...
**Task** Run the following code. Describe the output in the space below. 
**Answer** We can now see the map showing the number of foreclosure notices per 1000 population. The highest number in bright blue is Charles County
...
**Task** Run the following code. Describe the output in the space below. 
**Answer** It's now easier to see the areas with the highest number (Charles) and the lowest number (Montomgery, Howard and Garrett counites)
...
**Answer** It seems the richest counties (Montgomery, Howard, Frederick, Talbot) have the lowest rates. But not sure what to make of Garrett or Wicomico. 
